...
void BoundedDepthFirstSearch::Run(struct FDS) {
...
void RandomInputSearch::Run(struct FDS) {
  vector<value_t> input;
...
void RandomSearch::Run(struct FDS) {
...
void UniformRandomSearch::Run(struct FDS) {
  // Initial execution (on empty/random inputs).
...
void HybridSearch::Run(struct FDS) {
  SymbolicExecution ex;
...
void CfgBaselineSearch::Run(struct FDS) {
  SymbolicExecution ex;
...
void CfgHeuristicSearch::Run(struct FDS) {
